...
Реализуйте функцию `ProcessApplications(students []StudentApplication, courses []Course) (map[CourseName][]StudentName, []StudentApplication)`, 
...
Первое возвращаемое значение — хэш-таблица со слайсами имён студентов `[]StudentName`, 
поступивших на курс с названием `CourseName`. 
**Важно: слайсы `[]StudentName` должны быть отсортированы по возрастанию фамилии и имени.**

Второе значение — студенты, которым не досталось ни одного курса: слайс `[]StudentApplication`, 
отсортированный по **убыванию** `Avg`, затем по **возрастанию** фамилии и имени (как в основной сортировке по имени).
