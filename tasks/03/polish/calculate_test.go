...
func TestCalculate(t *testing.T) {
	testCases := []struct {
		...
		{expr: "17 5 /", expectedValue: 3},
		{expr: "-17 5 /", expectedValue: -3},
		{expr: "7 -2 /", expectedValue: -3},
		{expr: "42 -", expectedValue: -42},
		{expr: "0 5 -", expectedValue: -5},
		{expr: "1000 10 /", expectedValue: 100},
		{expr: "1 0 /", wantResult: InvalidExpressionErr},
